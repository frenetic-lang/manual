...
\includegraphics{netkat_policy_combinators_seq}
...
\includegraphics{netkat_policy_combinators_set_port}
...
\includegraphics{netkat_overlapping_union}
...
\includegraphics{netkat_overlapping_if_then_else}
...
The following code is in \texttt{code/netkat\_principles/repeater3.py}:
