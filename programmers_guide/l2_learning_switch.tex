...
watch the Ethernet MAC addresses of traffic and remember their respective ports.  In other words, it 
...
The following code is in \netkat{code/l2_learning_switch/network_information_base.py}:
...
The following code is in \netkat{code/l2_learning_switch/learning1.py}:
